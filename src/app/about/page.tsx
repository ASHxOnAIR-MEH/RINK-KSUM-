    ...
    <div className="bg-white min-h-screen text-gray-900">
      ...
      <div className="border-b border-gray-100 py-16" style={{ background: 'linear-gradient(135deg, #F0F6FF 0%, #EEF4FF 40%, #F8FAFF 100%)' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 rounded-full text-xs font-semibold text-[#2563EB] mb-5">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14 space-y-16">
        ...
        <div>
          <div className="mb-6">
            <div className="text-xs font-bold text-[#2563EB] uppercase tracking-widest mb-2">Who Is This For?</div>
            <h2 className="text-2xl font-heading font-bold text-gray-900">Built for the Innovation Ecosystem</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { icon: Target, label: 'Startup Founders', desc: 'Find technologies ready for commercialization', color: '#2563EB' },
              ...
              <div key={label} className="bg-gray-50 rounded-2xl border border-gray-100 p-5 text-center">
                <div className="w-11 h-11 rounded-xl mx-auto mb-3 flex items-center justify-center bg-white border border-gray-100 shadow-sm">
        ...
        {/* ── About KSUM / RINK ────────────────────────────── */}
        <div className="bg-[#F8FAFF] rounded-2xl border border-gray-100 p-8">
          <h2 className="font-heading font-bold text-gray-900 text-2xl mb-6">About Kerala Startup Mission &amp; RINK</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-semibold text-[#2563EB] mb-2 text-sm">Kerala Startup Mission (KSUM)</h3>
              ...
              <a href="https://startupmission.in" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-sm text-[#2563EB] font-semibold mt-3 hover:underline">
                startupmission.in <ArrowRight className="w-3.5 h-3.5" />
              </a>
            </div>
            <div>
              <h3 className="font-semibold text-[#2563EB] mb-2 text-sm">Research Innovation Network Kerala (RINK)</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
      ...
      <section className="py-20 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center mb-12">
            <div className="text-xs font-bold text-[#2563EB] uppercase tracking-widest mb-3">Contact RINK</div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+914712971190" className="text-sm font-semibold text-gray-900 hover:text-[#2563EB] transition-colors">+91-471-2971190</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@startupmission.in" className="text-sm font-semibold text-gray-900 hover:text-[#2563EB] transition-colors">info@startupmission.in</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://startupmission.in" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-gray-900 hover:text-[#2563EB] transition-colors">startupmission.in</a>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#2563EB] text-white text-xs font-bold hover:bg-[#1D4ED8] transition-colors font-heading"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#0A66C2] text-white text-xs font-bold hover:bg-[#084fa0] transition-colors font-heading"
                >
                  <LinkedInIcon className="w-3.5 h-3.5" /> LinkedIn
                </a>
                <a
                  href="mailto:info@startupmission.in"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white border border-gray-200 text-gray-700 text-xs font-bold hover:border-blue-300 hover:text-[#2563EB] transition-colors font-heading"
                >
