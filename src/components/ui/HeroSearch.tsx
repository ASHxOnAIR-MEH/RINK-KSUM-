...
export default function HeroSearch() {
  ...
  return (
    <form
      ...
      className="flex items-center w-full max-w-3xl bg-[#0A2164]/30 backdrop-blur-md border border-white/20 rounded-md shadow-2xl overflow-hidden"
    >
      ...
      <input
        ...
        className="w-full py-4 px-4 bg-transparent text-white placeholder:text-slate-400 focus:outline-none font-sans text-lg min-w-0"
      />
      <button
        type="submit"
